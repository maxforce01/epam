...
public class OrderReturnViewCommandTest extends Mockito {
	...
	public void testDoPost() throws Exception {
		...
		assertEquals(Path.COMMAND__ERROR_PAGE + "error.invalid.request",
				new OrderReturnViewCommand().execute(request, response, ActionType.POST));
	...
	public void testDoGet() throws Exception {
		...
		assertEquals(Path.LOGIN__PAGE, new OrderReturnViewCommand().execute(request, response, ActionType.GET));
	}
	...
	public void testDoGet2() throws Exception {
		...
		assertEquals(Path.PAGE__ERROR_PAGE, new OrderReturnViewCommand().execute(request, response, ActionType.GET));
	}
	...
	public void testDoGet4() throws Exception {
		...
		assertEquals(Path.COMMAND__ORDER_RETURN_VIEW, new OrderReturnViewCommand().execute(request, response, ActionType.GET));
	}
}
